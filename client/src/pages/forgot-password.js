...
const STEPS = [
  ...
  { n: "02", label: "New password" },
  { n: "03", label: "Confirm & save" },
];
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Steps */
        .auth-steps { margin-top:44px;display:flex;flex-direction:column;gap:18px;animation:fadeUp .5s .34s both; }
        .auth-step { display:flex;align-items:center;gap:16px; }
        .auth-step-num {
          width:38px;height:38px;border-radius:12px;flex-shrink:0;
          background:linear-gradient(135deg,rgba(99,102,241,.2),rgba(139,92,246,.15));
          border:1px solid rgba(99,102,241,.3);
          display:flex;align-items:center;justify-content:center;
          font-size:11px;font-weight:800;color:#818cf8;letter-spacing:.06em;
        }
        .auth-step-label { font-size:14px;font-weight:500;color:#cbd5e1; }
        ...
        /* Success state */
        .auth-success {
          display:flex;flex-direction:column;align-items:center;padding:48px 36px;text-align:center;
          animation:successPop .4s cubic-bezier(.4,0,.2,1) both;
        }
        .auth-success-icon {
        ...
        .auth-success-title { font-family:'Plus Jakarta Sans','Syne',sans-serif;font-size:22px;font-weight:800;color:#f1f5f9;margin-bottom:8px; }
        .auth-success-sub { font-size:14px;color:#64748b;line-height:1.6; }
          ...
          <section className="auth-left">
            ...
            <div className="auth-hero">
              ...
              <h1 className="auth-headline">
                Reset your
                <br />
                <span className="auth-headline-accent">password.</span>
              </h1>
              <p className="auth-subtext">
                Set a new password for your CollabHub account. You'll be
                redirected to sign in automatically once it's saved.
              </p>
            ...
            <svg className="auth-deco-ring" viewBox="0 0 320 320" fill="none">
              <circle cx="160" cy="160" r="150" stroke="url(#fg1)" strokeWidth="1" strokeDasharray="6 12" />
              <defs>
              ...
              {done ? (
                <div className="auth-success">
                  <div className="auth-success-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" className="h-8 w-8">
                      <path d="M20 6L9 17l-5-5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <div className="auth-success-title">Password updated!</div>
                  <div className="auth-success-sub">Redirecting you to sign in…</div>
                </div>
              ) : (
                <div className="auth-card-body">
                  <div className="auth-card-eyebrow">Account recovery</div>
                  <h2 className="auth-card-title">Reset password</h2>
                  <p className="auth-card-sub">Enter your email and choose a new password</p>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="auth-field">
                      ...
                      <div className="auth-inp-wrap">
                        ...
                        />
                        <button type="button" className="auth-eye" onClick={() => setShowNew((v) => !v)} aria-label="Toggle">
                    ...
                    <div className="auth-field">
                      ...
                      <div className="auth-inp-wrap">
                        ...
                        <input
                          ...
                          autoComplete="new-password"
                        />
                        <button type="button" className="auth-eye" onClick={() => setShowConfirm((v) => !v)} aria-label="Toggle">
                  ...
                  <div className="auth-footer-row">
                    ...
                    <button type="button" onClick={() => router.push("/login")}>Back to Sign In</button>
                  </div>
                </div>
              )}
            </div>
