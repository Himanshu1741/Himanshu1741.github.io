      ...
      <div className="layout dashboard-layout">
        <section className="left dashboard-left">
          ...
          <div className="hero-text">
            ...
            <p className="hero-sub">Manage personal details and password to keep your account protected.</p>
          </div>
        </section>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-lg font-semibold text-white">
                {user?.name} <span className="text-cyan-300">({user?.role})</span>
              </p>
        ...
        <div className="panel-card p-5">
          <div className="grid gap-6 xl:grid-cols-2">
            <form onSubmit={updateProfile} className="grid gap-3">
              <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-300">Profile</h4>
              <input
            ...
            <form onSubmit={changePassword} className="grid gap-3">
              <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-300">Password</h4>
              <input
                type="password"
                className="input-modern"
